        ...
        <>
            {
                data.map((d) => (
                    <div className="transaction_card" key={d.id}>
                        <div
                            className="d-flex justify-content-between align-items-center flex-wrap transaction_hash_section">
                            <div className=" d-flex justify-content-between align-items-center flex-wrap">
                                <div className="hash">Transaction Hash</div>
                                <div className='hash'>&nbsp; :</div>
                            </div>
                            <div
                                className="transaction_hash d-flex justify-content-between align-items-center flex-wrap">
                                <div className='hash_code'>{d.transaction_hash}</div>
                        ...
                        <div className="d-flex justify-content-between align-items-center flex-wrap">
                            ...
                            <div className="from_hash d-flex justify-content-between align-items-center flex-wrap">
                                <div className='hash_code'>{d.from}</div>
                        ...
                        <button className="view_transaction">View Transaction</button>
