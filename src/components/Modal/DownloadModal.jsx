                    ...
                    <div className="modal-dialog modal-lg modal-dialog-centered">
                        <div className="modal-content" style={{borderRadius: "30px"}}>
                            ...
                            <div className="modal-body">
                                <div
                                    className="d-flex justify-content-center gap-1 gap-sm-0 flex-column flex-sm-row justify-content-sm-between flex-wrap align-items-center mt-2">
                            ...
                            >
                                ...
                                <button
                                    ...
                                    onClick={handleClose}
                                >
                                    <img style={{width: "118px"}} className="img-fluid" src={Logo}
                                         alt="paypal"/>
                                </button>
                            </div>
                        </div>
